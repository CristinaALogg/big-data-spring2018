...
def tif2array(location):
  B1_raster = os.path.join(DATA, 'LC08_L1TP_012031_20170614_20170628_01_T1_B1.tif')  #Adds to array.
  B1_data = gdal.Open(B1_raster)
  B1 = B1_data.ReadAsArray()
  B1_band = B1_data.GetRasterBand(1)
  B1 = B1_band.ReadAsArray()
  type(B1)
    """
    Should:
